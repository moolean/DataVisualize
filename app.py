...
# 获取图片目录
IMAGE_FOLDER = '/mnt/afs/user/yuhaojia/data/eastmoney_report_img'
...
def view_image(image_index):
    ...
    saved_num = count_files_in_directory('images/')
...
def save_image(image_name, next_index):
    ...
    target_path = 'images/'+ image_name # 目标路径，确保目录已存在
...
if __name__ == '__main__':
    # 在大装置网页端可以打开公网端口
    app.run(debug=False, host="0.0.0.0",port=11235)
